...
import com.gravifox.domain.member.dto.login.LoginResponse;
...
public class AuthController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "토큰 갱신 성공", content = @Content(mediaType = "application/json"))
            }
    )
    @PostMapping("/refresh")
    ...
    @Operation(
            ...
            responses = {@ApiResponse(responseCode = "200", description = "로그아웃 성공", content = @Content(mediaType = "application/json"))}
    )
    @PostMapping("/logout")
